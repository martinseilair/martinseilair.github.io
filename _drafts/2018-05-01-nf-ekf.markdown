...
<script>
	...
	n_scene.step = function(){
		...
		if(this.t % 4 == 0){
			...
			//console.log(C, this.output/C, this.ekf.output_sigma(this.ekf.posterior_mu)/(C*C), this.rt)
			...
			//console.log("state", this.rc.state);
...
//console.log(this.ekf.posterior_sigma)
//this.rt.update_strip("outer", get_gaussian_circ_normalized(this.rt.strip_pos, this.ekf.posterior_mu, this.ekf.posterior_sigma, this.rt));
